...
static const size_t WriterNestingLevels = 2048 / (2 * sizeof(size_t));
typedef rapidjson::Writer<DirectStringBuffer, rapidjson::UTF8<>, rapidjson::UTF8<>, StackAllocator, rapidjson::kWriteNoFlags> JsonWriterBase;
...
typedef rapidjson::GenericDocument<rapidjson::UTF8<>, PoolAllocator, StackAllocator> JsonDocumentBase;
...
typedef rapidjson::GenericValue<rapidjson::UTF8<>, PoolAllocator> JsonValue;
